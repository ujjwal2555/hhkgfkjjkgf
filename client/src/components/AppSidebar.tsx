...
export function AppSidebar() {
  ...
  const allMenuItems = [
    ...
    { title: 'My Payroll', url: '/my-payroll', icon: Wallet, roles: ['employee'] },
    { title: 'Payroll', url: '/payroll', icon: Wallet, roles: ['admin', 'payroll'] },
    { title: 'Reports', url: '/reports', icon: BarChart3, roles: ['admin', 'payroll'] },
    { title: 'Profile', url: '/profile', icon: UserCircle, roles: ['admin', 'hr', 'payroll', 'employee'] },
    { title: 'Settings', url: '/settings', icon: Settings, roles: ['admin', 'payroll'] },
